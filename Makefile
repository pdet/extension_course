...
EXTENSION_FLAGS=-DDUCKDB_OOT_EXTENSION_NAMES="anonymize" -DDUCKDB_OOT_EXTENSION_ANONYMIZE_PATH="$(PROJ_DIR)" -DDUCKDB_OOT_EXTENSION_ANONYMIZE_SHOULD_LINK="TRUE" -DDUCKDB_OOT_EXTENSION_ANONYMIZE_INCLUDE_PATH="$(PROJ_DIR)src/include"
